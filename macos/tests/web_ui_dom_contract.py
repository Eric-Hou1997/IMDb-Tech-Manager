...
with tempfile.TemporaryDirectory(prefix="imdb-tech-ui-") as temp_dir:
    ...
    expected = {
        ...
        'data-tv-toolbar-threshold="ok"': "TV switches to the wrapped toolbar only when its controls would collide",
        ...
        'data-localized-toolbar-responsive="ok"': "Chinese and English controls wrap from measured content width and remain legible",
        'data-localized-region-responsive="ok"': "header and action regions wrap only when their measured content no longer fits",
        'data-future-locale-responsive="ok"': "unregistered long Latin and CJK labels use the same content-driven layout path",
...
print("OK v4.0.2 real DOM startup, persisted layout, fallback, alignment, and interaction contract")
