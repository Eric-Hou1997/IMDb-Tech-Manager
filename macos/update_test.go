...
func TestCompareVersion(t *testing.T) {
	...
	if _, err := compareVersion("4.0", "v4.0.1"); err == nil {
...
func TestSelectTechUpdateAssetsRequiresCanonicalName(t *testing.T) {
	release := githubRelease{
		...
		Assets: []githubReleaseAsset{
			{Name: "ITM-v4.0.1-MacOS-AArch64-APP.zip", BrowserDownloadURL: "archive"},
			{Name: "ITM-v4.0.1-MacOS-AArch64-APP.zip.sig", BrowserDownloadURL: "signature"},
			{Name: "ITM-v4.0.1-Windows-x64-EXE.zip", BrowserDownloadURL: "wrong-platform"},
		},
	}
	...
	release.Assets = []githubReleaseAsset{
		{Name: "IMDb-Tech-Manager-macOS-v4.0.1-AppleSilicon-App.zip"},
		{Name: "IMDb-Tech-Manager-macOS-v4.0.1-AppleSilicon-App.zip.sig"},
	}
